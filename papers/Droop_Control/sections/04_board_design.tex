...
% NOTE(orchestrator): RESOLVED 2026-08-17 — the project-wide bus nominal is
% 16.0 V (V_0 = 15.91 V measured no-load, 2026-07-11 RD1 = 215k FB retune).
% The rev-20260622 17.5 V design value is stale; do not reintroduce it.
% Section \ref{sec:droop} already uses the 16 V-retune constants.
% =====================================================================
...
%
% 2. BUS VOLTAGE (RESOLVED 2026-08-17): the project-wide nominal is 16.0 V
%    (V_0 = 15.91 V, 2026-07-11 retune; Sec. \ref{sec:droop} constants).
%    The original 17.5 V prose value was stale and has been removed; when
%    the voltage is stated here, state 16.0 V.
%
