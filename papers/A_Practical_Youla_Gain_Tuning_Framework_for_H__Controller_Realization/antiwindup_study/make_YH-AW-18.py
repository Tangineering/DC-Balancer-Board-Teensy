...
h,l=ax[0].get_legend_handles_labels(); fig.legend(h,l,frameon=False,fontsize=7,loc='lower center',ncol=2,bbox_to_anchor=(0.5,-0.01)); fig.subplots_adjust(bottom=0.30); ax[0].set_xlim(0,12)
for a in ax: a.grid(alpha=0.25,lw=0.4)
out=os.path.join(os.path.dirname(os.path.abspath(__file__)),'figures','python','YH-AW-18')
