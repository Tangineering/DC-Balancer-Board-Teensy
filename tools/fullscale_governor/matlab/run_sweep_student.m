%% RUN_SWEEP_STUDENT -- the student's sweep_governor_scale.m on his own
%  simulink_pdem_output_UDDS.mat (his loader verbatim) (variable P_dem1, 1x1370) because the original
...
% The student's own loader, verbatim from sweep_governor_scale.m section 1.
data2 = load(getenv('PDEM_FILE'), 'out');
