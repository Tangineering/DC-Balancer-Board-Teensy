...
| **OQ-14** | Does `ems-drive-cycle` literally exist in the `SCENARIOS` registry? | `CLAUDE.md` 2026-08-27e says it was added; research brief 4 §2 did not find it by that name during the research pass. **Verified 2026-08-30: it exists** (`tools/hil_plant_sim.py:974`, 60 s, `hold-5050` EMS, 8-point profile) — the research pass missed it | §6.2 Tier-B row added | **CLOSED** — verified against the registry |
